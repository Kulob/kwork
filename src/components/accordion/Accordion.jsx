...
export const Accordion = ({ section, key }) => {
  ...
  console.log(section);
  return (
    <div className="bg-white rounded-[25px] w-[1390px] pt-[20px] px-[20px] accordion mb-7 xl:w-[1200px]">
      <ExpendableColumn
...
export const ExpendableColumn = ({ question, isOpen, toggle }) => {
  return (
    <div className=" flex justify-between items-center text-center h-[80px]" onClick={toggle}>
